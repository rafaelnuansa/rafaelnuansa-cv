  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'Rafael Nuansa CV' },
        { hid: 'og:title', property: 'og:title', content: siteTitle },
        { hid: 'og:description', property: 'og:description', content: 'Rafael Nuansa CV' },
        { hid: 'og:image', property: 'og:image', content: 'demo-share.jpg' },
        { hid: 'og:url', property: 'og:url', content: 'https://rafaenuansa.netlify.app/' },
